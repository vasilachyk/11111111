...
void XKeyMapTable::InitVirtualKeyString()
{
	...
	VKEY_STR(VKEY_UI_PALETTE10, "PALETTE10");
	VKEY_STR(VKEY_UI_PALETTE11, "PALETTE11");
	VKEY_STR(VKEY_UI_PALETTE12, "PALETTE12");
	VKEY_STR(VKEY_UI_PALETTE13, "PALETTE13");
	VKEY_STR(VKEY_UI_PALETTE14, "PALETTE14");
	VKEY_STR(VKEY_UI_PALETTE15, "PALETTE15");
	VKEY_STR(VKEY_UI_PALETTE16, "PALETTE16");
	VKEY_STR(VKEY_UI_PALETTE17, "PALETTE17");
	VKEY_STR(VKEY_UI_PALETTE18, "PALETTE18");
	VKEY_STR(VKEY_UI_PALETTE19, "PALETTE19");
	VKEY_STR(VKEY_UI_PALETTE20, "PALETTE20");
	VKEY_STR(VKEY_UI_PALETTE21, "PALETTE21");
	VKEY_STR(VKEY_UI_PALETTE22, "PALETTE22");
	VKEY_STR(VKEY_UI_PALETTE23, "PALETTE23");
	VKEY_STR(VKEY_UI_PALETTE24, "PALETTE24");
	VKEY_STR(VKEY_UI_PALETTE25, "PALETTE25");
	VKEY_STR(VKEY_UI_PALETTE26, "PALETTE26");
	VKEY_STR(VKEY_UI_PALETTE27, "PALETTE27");
	VKEY_STR(VKEY_UI_PALETTE28, "PALETTE28");
	VKEY_STR(VKEY_UI_PALETTE29, "PALETTE29");
}
