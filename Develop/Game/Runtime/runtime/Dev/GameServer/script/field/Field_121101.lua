...
function Field_121101:OnCreate()
	Field_121101.NPC_Flower1 = {27, 28, 29, 32, 33, 136, 139, 146, 164, 165}
	Field_121101.NPC_Flower3 = {140, 141, 142, 143, 144, 160, 161, 162, 163}
	Field_121101.NPC_Flower7 = {91, 92, 93, 138, 145, 147}
	
	Field_121101.BUFF_FlowerPoison = 88010
end


function Field_121101:OnSensorTalent_15(Actor, TalentID) -- 15번 센서에서 레버를 댕기면 
...
function Field_121101:OnSensorTalent_16(Actor, TalentID) -- 16번 센서에서 레버를 댕기면 
...
function Field_121101:OnSensorTalent_21(Actor, TalentID) -- 21번 센서에서 레버를 댕기면
--	GLog("Field_121101:OnSensorTalent_21() "..TalentID.."\n")
...
function Field_121101:OnSensorEnter_1(Actor)
...
function Field_121101:OnSensorEnter_2(Actor) -- 가시덩굴 더미 삭제 
	if (Actor:IsPlayer() == true) then
		local Field = AsPlayer(Actor):GetField()
...
function Field_121101:OnSensorEnter_3(Actor) 
	if (Actor:IsPlayer() == true) then
		local Field = AsPlayer(Actor):GetField()
		...
		for i, id in ipairs( Field_121101.NPC_Flower3 ) do
			local Flower = this:GetSpawnNPC( id )
			Flower:GainBuff( Field_121101.BUFF_FlowerPoison )
		end	
...
function Field_121101:OnSensorEnter_4(Actor) -- 봉봉 뒤에서 출현 
	if (Actor:IsPlayer() == true) then
		local Field = AsPlayer(Actor):GetField()
...
function Field_121101:OnSensorEnter_6(Actor) -- room on
	if (Actor:IsPlayer() == true) then
		local Field = AsPlayer(Actor):GetField()		
		Field:ActivateSpawnGroup(1)
		
		for i, id in ipairs(Field_121101.NPC_Flower1) do
			local Flower = this:GetSpawnNPC( id )
			Flower:GainBuff( Field_121101.BUFF_FlowerPoison )
...
function Field_121101:OnSensorEnter_7(Actor) -- 1번째 room on
	if (Actor:IsPlayer() == true) then
		local Field = AsPlayer(Actor):GetField()		
...
function Field_121101:OnSensorEnter_10(Actor) 
	if (Actor:IsPlayer() == true) then
		local Field = AsPlayer(Actor):GetField()		
...
function Field_121101:OnSensorEnter_11(Actor) 
	if (Actor:IsPlayer() == true) then
		local Field = AsPlayer(Actor):GetField()		
...
function Field_121101:OnSensorEnter_12(Actor)
--	GLog("Field_121101:OnSensorEnter_12()\n")
	...
	if (Actor:IsPlayer() == true) then
		...
		for i, id in ipairs( Field_121101.NPC_Flower7 ) do
			local Flower = this:GetSpawnNPC( id )
			Flower:GainBuff( Field_121101.BUFF_FlowerPoison )
		end
...
function Field_121101:OnDie(DespawnInfo)
...
function Field_121101:OnSpawn(SpawnInfo)
