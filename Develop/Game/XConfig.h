...
#define XGETCFG_KEY_PALETTE10(_code,_ext)			_get_key_data( "KEY,PALETTE10", _code, "KEY_1", _ext, "alt")
#define XSETCFG_KEY_PALETTE10(_code,_ext)			_set_key_data( "KEY,PALETTE10", _code, _ext)
#define XGETCFG_KEY_PALETTE11(_code,_ext)			_get_key_data( "KEY,PALETTE11", _code, "KEY_2", _ext, "alt")
#define XSETCFG_KEY_PALETTE11(_code,_ext)			_set_key_data( "KEY,PALETTE11", _code, _ext)
#define XGETCFG_KEY_PALETTE12(_code,_ext)			_get_key_data( "KEY,PALETTE12", _code, "KEY_3", _ext, "alt")
#define XSETCFG_KEY_PALETTE12(_code,_ext)			_set_key_data( "KEY,PALETTE12", _code, _ext)
#define XGETCFG_KEY_PALETTE13(_code,_ext)			_get_key_data( "KEY,PALETTE13", _code, "KEY_4", _ext, "alt")
#define XSETCFG_KEY_PALETTE13(_code,_ext)			_set_key_data( "KEY,PALETTE13", _code, _ext)
#define XGETCFG_KEY_PALETTE14(_code,_ext)			_get_key_data( "KEY,PALETTE14", _code, "KEY_5", _ext, "alt")
#define XSETCFG_KEY_PALETTE14(_code,_ext)			_set_key_data( "KEY,PALETTE14", _code, _ext)
#define XGETCFG_KEY_PALETTE15(_code,_ext)			_get_key_data( "KEY,PALETTE15", _code, "KEY_6", _ext, "alt")
#define XSETCFG_KEY_PALETTE15(_code,_ext)			_set_key_data( "KEY,PALETTE15", _code, _ext)
#define XGETCFG_KEY_PALETTE16(_code,_ext)			_get_key_data( "KEY,PALETTE16", _code, "KEY_7", _ext, "alt")
#define XSETCFG_KEY_PALETTE16(_code,_ext)			_set_key_data( "KEY,PALETTE16", _code, _ext)
#define XGETCFG_KEY_PALETTE17(_code,_ext)			_get_key_data( "KEY,PALETTE17", _code, "KEY_8", _ext, "alt")
#define XSETCFG_KEY_PALETTE17(_code,_ext)			_set_key_data( "KEY,PALETTE17", _code, _ext)
#define XGETCFG_KEY_PALETTE18(_code,_ext)			_get_key_data( "KEY,PALETTE18", _code, "KEY_9", _ext, "alt")
#define XSETCFG_KEY_PALETTE18(_code,_ext)			_set_key_data( "KEY,PALETTE18", _code, _ext)
#define XGETCFG_KEY_PALETTE19(_code,_ext)			_get_key_data( "KEY,PALETTE19", _code, "KEY_0", _ext, "alt")
#define XSETCFG_KEY_PALETTE19(_code,_ext)			_set_key_data( "KEY,PALETTE19", _code, _ext)

#define XGETCFG_KEY_PALETTE20(_code,_ext)			_get_key_data( "KEY,PALETTE20", _code, "KEY_1", _ext, "shift")
#define XSETCFG_KEY_PALETTE20(_code,_ext)			_set_key_data( "KEY,PALETTE20", _code, _ext)
#define XGETCFG_KEY_PALETTE21(_code,_ext)			_get_key_data( "KEY,PALETTE21", _code, "KEY_2", _ext, "shift")
#define XSETCFG_KEY_PALETTE21(_code,_ext)			_set_key_data( "KEY,PALETTE21", _code, _ext)
#define XGETCFG_KEY_PALETTE22(_code,_ext)			_get_key_data( "KEY,PALETTE22", _code, "KEY_3", _ext, "shift")
#define XSETCFG_KEY_PALETTE22(_code,_ext)			_set_key_data( "KEY,PALETTE22", _code, _ext)
#define XGETCFG_KEY_PALETTE23(_code,_ext)			_get_key_data( "KEY,PALETTE23", _code, "KEY_4", _ext, "shift")
#define XSETCFG_KEY_PALETTE23(_code,_ext)			_set_key_data( "KEY,PALETTE23", _code, _ext)
#define XGETCFG_KEY_PALETTE24(_code,_ext)			_get_key_data( "KEY,PALETTE24", _code, "KEY_5", _ext, "shift")
#define XSETCFG_KEY_PALETTE24(_code,_ext)			_set_key_data( "KEY,PALETTE24", _code, _ext)
#define XGETCFG_KEY_PALETTE25(_code,_ext)			_get_key_data( "KEY,PALETTE25", _code, "KEY_6", _ext, "shift")
#define XSETCFG_KEY_PALETTE25(_code,_ext)			_set_key_data( "KEY,PALETTE25", _code, _ext)
#define XGETCFG_KEY_PALETTE26(_code,_ext)			_get_key_data( "KEY,PALETTE26", _code, "KEY_7", _ext, "shift")
#define XSETCFG_KEY_PALETTE26(_code,_ext)			_set_key_data( "KEY,PALETTE26", _code, _ext)
#define XGETCFG_KEY_PALETTE27(_code,_ext)			_get_key_data( "KEY,PALETTE27", _code, "KEY_8", _ext, "shift")
#define XSETCFG_KEY_PALETTE27(_code,_ext)			_set_key_data( "KEY,PALETTE27", _code, _ext)
#define XGETCFG_KEY_PALETTE28(_code,_ext)			_get_key_data( "KEY,PALETTE28", _code, "KEY_9", _ext, "shift")
#define XSETCFG_KEY_PALETTE28(_code,_ext)			_set_key_data( "KEY,PALETTE28", _code, _ext)
#define XGETCFG_KEY_PALETTE29(_code,_ext)			_get_key_data( "KEY,PALETTE29", _code, "KEY_0", _ext, "shift")
#define XSETCFG_KEY_PALETTE29(_code,_ext)			_set_key_data( "KEY,PALETTE29", _code, _ext)
